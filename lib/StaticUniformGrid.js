...
function StaticUniformGrid(data, cellWidth, objectAABBFunction, cellCheckFunction) {
    ...
    console.log("building a grid for " + objectCount + " objects...");
    ...
    console.log("cellCount: " + cellCount + " resolution: " + resolution);
    ...
    console.log("Done binning. Finishing grid...");
