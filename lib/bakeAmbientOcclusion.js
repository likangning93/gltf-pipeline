    ...
    for (var i = 0; i < numTriangles; i++) {
        ...
        while(uStep < uMax) {
            ...
            while(vStep < vMax) {
                ...
                // offset the start position a little from the surface of the triangle to avoid self occlusion
                var offset = Cartesian3.multiplyByScalar(texelNormal, halfWidth, cartesian3Scratch1);
                var texelPosition = Cartesian3.add(texelPosition, offset, texelPosition);
