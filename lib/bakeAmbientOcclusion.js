...
function bakeAmbientOcclusion(gltf, aoOptions) {
   var options = generateOptions(gltf, aoOptions);
    ...
    if (useUniformGrid) {
        ...
        console.log("stats:");
        console.log("  resolution: " + raytracerScene.triangleSoup.resolution);
        console.log("  cloned data length: " + raytracerScene.triangleSoup.data.length);
        console.log("  AABB: " + raytracerScene.triangleSoup.axisAlignedBoundingBox);

        // compute average number of triangles per cell
        var cellCounts = raytracerScene.triangleSoup.cellCounts;
        var countsTotal = 0;
